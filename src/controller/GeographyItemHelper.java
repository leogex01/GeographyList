...
public class GeographyItemHelper {
	static EntityManagerFactory emfactory = Persistence.createEntityManagerFactory("GeographyList");
	 ...
	 * @return
	 */
	public List<GeographyItem> searchLanguageByCountry(String languageName) {
		// TODO Auto-generated method stub
		EntityManager em = emfactory.createEntityManager();
		em.getTransaction().begin();
